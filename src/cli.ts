...
import { createDeleteAction } from "./commands/delete";
import { createPublishAction } from "./commands/publish";
import { createFindAction } from "./commands/find";
import stoolie, { LogLevel } from 'stoolie';
import {createPublisher} from "./services/publisher";
import {createWatchAction} from "./commands/watch";
